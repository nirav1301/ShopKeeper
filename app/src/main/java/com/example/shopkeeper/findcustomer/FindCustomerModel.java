...
public class FindCustomerModel implements Serializable {
    ...
    @SerializedName("ShippingStateOrProvince")
    @Expose
    ...
    @SerializedName("MailingStreet1")
    @Expose
    private String mailingStreet1;
    @SerializedName("MailingCity")
    @Expose
    private String mailingCity;
    @SerializedName("MailingStateOrProvince")
    @Expose
    private String mailingStateOrProvince;
    ...
    public String getMailingStateOrProvince() {
        return mailingStateOrProvince;
    }

    public void setMailingStateOrProvince(String mailingStateOrProvince) {
